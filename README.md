...
![屏保预览](screenshot/ScreenShot_2026-07-07_184808_073.png)

在 macOS 系统偏好设置中选择 LifeClock 作为屏保，预览窗口显示自出生日期起已流逝的天:时:分:秒。

### 配置选项

![配置选项](screenshot/ScreenShot_2026-07-08_095340_710.png)

可自定义时间格式（24小时制/12小时制/中文）、出生日期（精确到秒）、缩放比例、亮度、背景显示及多显示器支持。

### 实时预览配置

![实时预览配置](screenshot/ScreenShot_2026-07-08_133332_510.png)
